package com.streamingvideolive.cordova.plugins.rtplibrary.base;
...
import com.streamingvideolive.cordova.plugins.encoder.audio.AudioEncoder;
import com.streamingvideolive.cordova.plugins.encoder.audio.GetAacData;
import com.streamingvideolive.cordova.plugins.encoder.input.audio.GetMicrophoneData;
import com.streamingvideolive.cordova.plugins.encoder.input.audio.MicrophoneManager;
import com.streamingvideolive.cordova.plugins.encoder.input.video.Camera1ApiManager;
import com.streamingvideolive.cordova.plugins.encoder.input.video.CameraHelper;
import com.streamingvideolive.cordova.plugins.encoder.input.video.CameraOpenException;
import com.streamingvideolive.cordova.plugins.encoder.input.video.Frame;
import com.streamingvideolive.cordova.plugins.encoder.input.video.GetCameraData;
import com.streamingvideolive.cordova.plugins.encoder.utils.CodecUtil;
import com.streamingvideolive.cordova.plugins.encoder.video.FormatVideoEncoder;
import com.streamingvideolive.cordova.plugins.encoder.video.GetVideoData;
import com.streamingvideolive.cordova.plugins.encoder.video.VideoEncoder;

import com.streamingvideolive.cordova.plugins.rtplibrary.view.GlInterface;
import com.streamingvideolive.cordova.plugins.rtplibrary.view.LightOpenGlView;
import com.streamingvideolive.cordova.plugins.rtplibrary.view.OffScreenGlThread;
...
public abstract class Camera1Base
   ...
   *
   * @param cameraFacing front or back camera. Like: {@link com.streamingvideolive.cordova.plugins.encoder.input.video.CameraHelper.Facing#BACK}
   * {@link com.streamingvideolive.cordova.plugins.encoder.input.video.CameraHelper.Facing#FRONT}
   * @param width of preview in px.
   * @param height of preview in px.
   * @param rotation camera rotation (0, 90, 180, 270). Recommended: {@link
   * com.streamingvideolive.cordova.plugins.encoder.input.video.CameraHelper#getCameraOrientation(Context)}
   */
